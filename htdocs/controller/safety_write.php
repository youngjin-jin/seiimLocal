...
if ($_POST['module'] == 'add_form') {
	...
	if ($templateType == '0') $curl_url = API_URL.'/app/submitEquip';
	else if ($templateType == '1') $curl_url = API_URL.'/app/submitSafe';
	else if ($templateType == '5') $curl_url = API_URL.'/app/submitSafe';
	else if ($templateType == '9') $curl_url = API_URL.'/app/submitSafe';
	else if ($templateType == '2') $curl_url = API_URL.'/app/submitBasicTest';
	else $curl_url = API_URL.'/app/submitInterview';
	$curl_data = array(
		'safetyDocId'=>$docId,
		'siteId'=>$siteId,
