...
if ($_POST['module'] == 'get_count') {
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => API_URL.'/app/safeDocModifyData?siteId='.$siteId.'&docId='.$docId.'&templateType='.$templateType.'&myCompanyId='.$myCompanyId,
	...
	if ($http_code == 200) {
		$response = array('result'=>true, 'list'=>$curl_response['list'], 'name'=>$_SESSION['name']);
	} else {
