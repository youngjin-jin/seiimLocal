...
<div id="header">
	<div class="inner">
		<div class="container">
			...
			<h1 class="title"><?php echo ${'templateType'.clean_xss_tags($_GET['templateType'])}?></h1>
		</div>
	</div>
</div>
<!-- // header -->
...
<style>
	.inp-item.radio_overwrap .inp-item.radio{margin-right:40px;}
	.inp-item.radio_overwrap .inp-item.radio + .inp-item.radio{margin-left:0;} 
</style>
...
<form id="add_form" method="post">
	...
	<input type="hidden" id="docId" value="<?php echo clean_xss_tags($_GET['docId'])?>" />
	<input type="hidden" id="templateType" value="<?php echo clean_xss_tags($_GET['templateType'])?>" />
...
<?php if (clean_xss_tags($_GET['templateType']) == '0') { ?>
...
<?php } else if (clean_xss_tags($_GET['templateType']) == '1') { ?>
...
<?php } else if (clean_xss_tags($_GET['templateType']) == '2') { ?>
			...
			<div class="basic-test">
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSdDsH30u1yVduMnFNW8E5n56NoPYQ-EeRv6_K7jGK91iKdJ6Q/viewform" class="bx-link mt20">
                    <i class="ic-basic-test"></i>
                    <p><?php echo $_lc['TXT']['기초안전보건테스트']?></p>
                </a>
                <p class="tit v2 mb6 mt40" id="input1_name"><?php echo $_lc['TXT']['Test결과']?></p>
                <div class="inp-wrap">
                    <div class="inp-item">
						<input type="text" name="input1" id="input1" class="number" maxlength="3" minlength="2" placeholder="<?php echo $_lc['TXT']['Test결과']?>" autocomplete="off" required>
                    </div>
                </div>
            </div>

<?php } else if (clean_xss_tags($_GET['templateType']) == '3') { ?>

			<div class="protective-gear oldForm">
				...
				<div class="inp-wrap radio4_1" style="display:none;">
					<div class="inp-item"><input type="text" name="input4_1_value" id="input4_1_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['과거병력수술해당부위병명']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input5_name"><?php echo $_lc['TXT']['산재유무']?></p>
				<div class="inp-wrap">
					<div class="inp-item radio">
						<label for="input5_1">
				...
				<div class="inp-wrap radio5_1" style="display:none;">
					<div class="inp-item"><input type="text" name="input5_1_value" id="input5_1_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['산재해당부위병명']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input6_1_name"><?php echo $_lc['TXT']['생활습관사항흡연갑일']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input6_1_value" id="input6_1_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['생활습관사항흡연갑일']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input6_2_name"><?php echo $_lc['TXT']['생활습관사항주량회주']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input6_2_value" id="input6_2_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['생활습관사항주량회주']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input6_3_name"><?php echo $_lc['TXT']['생활습관사항수면시간시간일']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input6_3_value" id="input6_3_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['생활습관사항수면시간시간일']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input7_1_name"><?php echo $_lc['TXT']['해당직종경력년수']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input7_1_value" id="input7_1_value" class="number" maxlength="2" placeholder="<?php echo $_lc['TXT']['해당직종경력년수']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input7_2_name"><?php echo $_lc['TXT']['비상연락처']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input7_2_value" id="input7_2_value" class="phone" maxlength="13" placeholder="<?php echo $_lc['TXT']['비상연락처']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input7_3_name"><?php echo $_lc['TXT']['비상연락처성명관계']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input7_3_value" id="input7_3_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['비상연락처성명관계']?>" autocomplete="off"></div>
				</div>
			</div>
			<!--
			<div class="protective-gear">
				...
				<p class="tit v2 mb6 mt20" id="input2_name"><?php echo $_lc['TXT']['비상연락처']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input2_value" id="input2_value" class="phone" maxlength="13" placeholder="<?php echo $_lc['TXT']['비상연락처']?>" autocomplete="off"></div>
				</div>
				<p class="tit v2 mb6 mt20" id="input3_name"><?php echo $_lc['TXT']['비상연락처성명관계']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input3_value" id="input3_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['비상연락처성명관계']?>" autocomplete="off"></div>
				</div>

				
				<p class="tit v2 mb6 mt20" id="input4_name"><?php echo $_lc['TXT']['현재건강상태']?></p>
				<div class="inp-wrap">
					<div class="inp-item radio">
						<label for="input4_1">
							<input type="radio" name="input4" id="input4_1" value="High">
							<p class="txt"><?php echo $_lc['TXT']['좋음']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input4_2">
							<input type="radio" name="input4" id="input4_2" value="Middle">
							<p class="txt"><?php echo $_lc['TXT']['보통']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input4_3">
							<input type="radio" name="input4" id="input4_3" value="Low">
				...
				<p class="tit v2 mb6 mt20" id="input5_name"><?php echo $_lc['TXT']['혈액형']?></p>
				<div class="inp-wrap">
					<div class="inp-item radio">
						<label for="input5_1">
							<input type="radio" name="input5" id="input5_1" value="A">
							<p class="txt">A</p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input5_2">
							<input type="radio" name="input5" id="input5_2" value="B">
							<p class="txt">B</p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input5_3">
							<input type="radio" name="input5" id="input5_3" value="O">
							<p class="txt">O</p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input5_4">
							<input type="radio" name="input5" id="input5_4" value="AB">
							<p class="txt">AB</p>
						</label>
					</div>
				</div>

				<p class="tit v2 mb6 mt20" id="input6_name"><?php echo $_lc['TXT']['혈압']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input6_value" id="input6_value" maxlength="50" placeholder="mmHg" autocomplete="off"></div>
				</div>
				...
				<p class="tit v2 mb6 mt20" id="input7_name"><?php echo $_lc['TXT']['해당직종경력']?></p>
				<div class="inp-wrap">
					<div class="inp-item"><input type="text" name="input7_1_value" id="input7_1_value" class="number" maxlength="2" placeholder="<?php echo $_lc['TXT']['해당직종경력년']?>" autocomplete="off"></div>
					<div class="inp-item"><input type="text" name="input7_2_value" id="input7_2_value" class="number" maxlength="2" placeholder="<?php echo $_lc['TXT']['해당직종경력개월']?>" autocomplete="off"></div>
				</div>

				<p class="tit v2 mb6 mt20" id="input8_name"><?php echo $_lc['TXT']['과거작업중재해유무']?></p>
				<div class="inp-wrap">
					<div class="inp-item radio">
						<label for="input8_1">
							<input type="radio" name="input8" id="input8_1" value="O">
							<p class="txt"><?php echo $_lc['TXT']['있다']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input8_2">
							<input type="radio" name="input8" id="input8_2" value="X">
				...
				<p class="tit v2 mb6 mt20" id="input9_name"><?php echo $_lc['TXT']['있다면과거에산재처리를한적이있습니까']?></p>
				<div class="inp-wrap">
					<div class="inp-item radio">
						<label for="input9_1">
				...
				<p class="tit v2 mb6 mt20 radio9_1" id="input9_3_name" style="display:none;"><?php echo $_lc['TXT']['산재해당부위병명']?></p>
				<div class="inp-wrap radio9_1" style="display:none;">
					<div class="inp-item"><input type="text" name="input9_3_value" id="input9_3_value" maxlength="50" placeholder="<?php echo $_lc['TXT']['산재해당부위병명']?>" autocomplete="off"></div>
				</div>

				<p class="tit v2 mb6 mt20" id="input10_name"><?php echo $_lc['TXT']['의사에게주의받은병이있습니까']?></p>
				<div class="inp-wrap radio_overwrap">
					<div class="inp-item radio">
						<label for="input10_1">
							<input type="radio" name="input10" id="input10_1" value="hbp">
							<p class="txt"><?php echo $_lc['TXT']['있다고혈압']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input10_2">
							<input type="radio" name="input10" id="input10_2" value="heart">
							<p class="txt"><?php echo $_lc['TXT']['있다심장']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input10_3">
							<input type="radio" name="input10" id="input10_3" value="diabetes">
							<p class="txt"><?php echo $_lc['TXT']['있다당뇨']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input10_4">
							<input type="radio" name="input10" id="input10_4" value="disc">
							<p class="txt"><?php echo $_lc['TXT']['있다디스크']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input10_5">
							<input type="radio" name="input10" id="input10_5" value="etcs">
							<p class="txt"><?php echo $_lc['TXT']['있다기타']?></p>
						</label>
					</div>
					<div class="inp-item radio">
						<label for="input10_6">
							<input type="radio" name="input10" id="input10_6" value="X">
							<p class="txt"><?php echo $_lc['TXT']['없다']?></p>
						</label>
					</div>
				</div>
...
<?php } else if (clean_xss_tags($_GET['templateType']) == '4') { ?>
	<!--보호구 - 호반-->
			<div class="protective-gear">
				<p class="tit v2 mb6" id="input1_name"><?php echo $_lc['TXT']['안전모']?></p>
				<div class="inp-wrap">
...
<?php } else if (clean_xss_tags($_GET['templateType']) == '5') { ?>
	<!--서약서 - 호반-->
			<div class="pledge-wrap">
                <p class="tit v5"><?php echo $_lc['TXT']['안전수칙준수서약']?></p>
                <ul class="list-wrap v4 mt20">
...
<?php } else if (clean_xss_tags($_GET['templateType']) == '6') { ?>
	<!--면담폼 - 호반-->
	<div class="protective-gear">
...
<?php } else if (clean_xss_tags($_GET['templateType']) == '7') { ?>
	<!--혈압용지 - 호반-->
			<div class="bloodWrap">
			...
			<?php } else if (clean_xss_tags($_GET['templateType']) == '8') { ?>
...
<!-- 안전수칙준수 서약서 -->
<?php } else if (clean_xss_tags($_GET['templateType']) == '9') { ?>
	<div class="pledge-wrap">
		<div class="inp-wrap">
		...
		<script>
			$(function () {
				$('.openrow').click(function(){
					$(this).next('.agreetxt').toggle();
				});

				$("#ag_chkall").click(function() {
					if($("#ag_chkall").is(":checked")) $("input[name=agree]").prop("checked", true);
				...
				$("input[name=agree]").click(function() {
					...
					if(total != checked) $("#ag_chkall").prop("checked", false);
					else $("#ag_chkall").prop("checked", true); 
				});
			});
		</script>
...
<!-- 기초안전보건 테스트 -->				
<?php } else if (clean_xss_tags($_GET['templateType']) == '10') { ?>
	<div class="basic-test">
		<dl class="field-code mt4">
			<dt><?PHP echo $_lc['TXT']['현장코드']?></dt>
			<dd><?php echo clean_xss_tags($_GET['key'])?></dd>
...
<!-- 면접 및 면담 진행현황 -->				
<?php } else if (clean_xss_tags($_GET['templateType']) == '11') { ?>
	<div class="protective-gear oldForm">
...
<!-- 근골격계질환 증상조사서 -->
<?php } else if (clean_xss_tags($_GET['templateType']) == '12') { ?>
	<div class="protective-gear diseaseForm">
		...
		<div class="col-wrap input7_area" style='display:none'>
			...
			<div class="inp-item radio">
				<label for="input7_2_1">
					<input type="radio" name="input7_2" id="input7_2_1" value="어깨">
					<p class="txt">어깨</p>
				</label>
			</div>
			<div class="inp-item radio">
				<label for="input7_2_2">
					<input type="radio" name="input7_2" id="input7_2_2" value="목">
					<p class="txt">목</p>
				</label>
			</div>
			<div class="inp-item radio">
				<label for="input7_2_2">
					<input type="radio" name="input7_2" id="input7_2_2" value="허리">
					<p class="txt">허리</p>
				</label>
			</div>
			<div class="inp-item radio">
				<label for="input7_2_2">
					<input type="radio" name="input7_2" id="input7_2_2" value="다리/발">
					<p class="txt">다리/발</p>
				</label>
			</div>
		</div>
		...
		<div class="diseaseBox" id="db_arm"  style='display:none'>
			...
			<div class="inp-wrap">
				<div class="inp-item radio">
					<label for="part_3_1_value1">
						<input type="radio" name="part_3_1_value" id="part_3_1_value1" value="1일 미만">
						<p class="txt">1일 미만</p>
					</label>
				</div>
				<div class="inp-item radio">
...
<?php } ?>
	...
	<div id="fixed">
		<div class="inner">
			<div class="btn-wrap">
				<button type="submit" class="btn lg has-ic bg-navy"><i class="ic-submit"></i><?php echo (clean_xss_tags($_GET['templateType']) == '1')?$_lc['BTN']['서명']:$_lc['BTN']['제출']?></button>
			</div>
		</div>
	</div>
	<!-- // fixed -->
