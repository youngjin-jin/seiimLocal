			...
			$.ajax({
				...
				success: function (response) {
					...
					{						
						...
						if(response.list.content.input4_1 == '기타')
						{
							$("#input4_2").show();
						...
						if(response.list.content.input7_1 == 'Y')
						{
							...
							if(response.list.content.part_1_5_value == '기타')
							{
								$("#part_1_6_value").show();
							...
							if(response.list.content.part_2_6_value == '기타')
							{
								$("#part_2_7_value").show();
							...
							if(response.list.content.part_3_6_value == '기타')
							{
								$("#part_3_7_value").show();
							...
							if(response.list.content.part_4_6_value == '기타')
							{
								$("#part_4_7_value").show();
							...
							if(response.list.content.part_5_5_value == '기타')
							{
								$("#part_5_6_value").show();
							...
							if(response.list.content.part_6_6_value == '기타')
							{
								$("#part_6_7_value").show();
