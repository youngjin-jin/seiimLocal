	...
	<form id="login_form" method="post">
		<div class="login-form">
			...
			<div class="btn-wrap fx jc-c mt20">
				<a href="/view/admin/<?php echo $device?>/html/find_account_id.php" class="btn-txt has-ic"><i class="ic-find-account"></i><?php echo $_lc['TXT']['ID/비밀번호찾기']?></a>
				<!--a href="/view/admin/<?php echo $device?>/html/writing_management.php" class="btn-txt has-ic"><i class="ic-join"></i><?php echo $_lc['TXT']['회원가입']?></a-->
			</div>
		</div>
	</form>
